...
static inline char *watchdog_fd(void) { return ""; }

static inline int watchdog_timeout(int timeout) { return 0; }

static inline int watchdog_frequency(int frequency) { return 0; }

static inline void watchdog_set_magicclose(bool val) {}

static inline bool watchdog_get_magicclose(void) { return false; }

static inline void watchdog_set_stopped(bool val) {}

static inline bool watchdog_get_stopped(void) { return true; }
